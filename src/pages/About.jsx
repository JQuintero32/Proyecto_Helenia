...
// Importación de los estilos personalizados para la vista About
import '../styles/About.css';

// Importación de recursos visuales (Logotipos e Imágenes del equipo)
...
/**
 * Componente About: Muestra la información institucional del proyecto,
 * incluyendo Misión, Visión, la identidad de "Helenía" y los perfiles de los creadores.
 */
function About() {
  // Arreglo de objetos con los datos del equipo para renderizar dinámicamente
  const creadores = [
  ...
  return (
    <div className="about-page pb-5">
      <div className="container custom-container py-5">
        ...
        {/* Generación dinámica de tarjetas utilizando .map() */}
